...
<body>
	...
	<div class="row">
			<div class="col-sm-12 text-center">
				<p class="a"><br><span class="title">評價紀錄</span></p><br>
				<%
	...
	try {
		...
		try 
		{
			...
			{	
				...
				sql = "SELECT * FROM `board` where userName='"+session.getAttribute("account")+"';";
				ResultSet rs =con.createStatement().executeQuery(sql);
				while(rs.next()){
					sql="select * from `products` where no="+rs.getInt("no");
					ResultSet rs2 =con.createStatement().executeQuery(sql);
					rs2.next();
					out.print("<div class='container-sm'>");
					out.print("產品名稱 : "+rs2.getString("proName")+"&nbsp;");
					out.print("購買日期 : "+rs.getString("b_date")+"&nbsp;");
					out.print("評分 : "+rs.getInt("score")+"&nbsp;");
					out.print("評論 : "+rs.getString("cmt")+"&nbsp;");
					out.print("</div><br>");
				}
				con.close();
			}   
