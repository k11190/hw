...
<body>
	<header>
			<nav class="navbar navbar-expand-lg" >
				...
				<div class="container justify-content-end">
					...
					<li class="nav-item"><a href="cart.jsp" title="" class="nav-link"><img src="../../image/shopping.png" alt="" class="shopping"></a></li>
				</ul>
			</div>
		</nav>
	...
	<section>
		<div class="row text-center">
			<div class="col-sm-12">
			<br><p><span class="title">購物車</span></p><br>
			<form action="cart.jsp" method="Post" accept-charset="utf-8" name="form1">
<%
						...
						try {
							...
							{	
								if(session.getAttribute("account") != null ){
									...
									sql = "SELECT * FROM shoppingcar WHERE userName='" +session.getAttribute("account")+"';"; 
									ResultSet rs2 =con.createStatement().executeQuery(sql);	
											
									while(rs2.next()){
										out.print("<div class='container-sm'>");
										out.print("<input type='checkbox' name='A' style='zoom:180%' id='check' value='"+rs2.getInt("no")+"'>");
										out.print(rs2.getString("product"));
										out.print(" 數量:"+rs2.getInt("amount"));
										out.print(" 小計:NT$"+rs2.getInt("subtotal"));
										out.print(" 取貨日期:"+rs2.getString("t_date"));
										out.print("</div><br>");
									}
								}
							}
...
%>			
				...
				<button type="submit" onclick="det()" class="delete"><img src="../../image/delete.png" alt="" width="100px" height="100px"></button>
				<button type="submit" onclick="buy()" class="buy"><img src="../../image/buy.png" alt="" width="110px" height="100px"></button>
			</div>
			</form>	
			</div>
...
%>
	<script type="text/javascript" src="../../js/top.js"></script>
    	...
    	function det() {
        	document.form1.action = "Delcart.jsp";//要改成連到刪除介面
        	document.form1.submit();
    	}
	</script>
</body>
